...
var regex = new RegExp("../housing/woodframe/.+");
return rp(url).then(async function (html) {
  var houses = $("a", html);
      ...
      .then(async function (html2) {
        try {
          ...
          var bedroomText = bedrooms
            .text()
            .replace(
              " The University recognizes that any housing built prior to 1978 may contain lead-based paint and/or lead-based paint hazards.  By accepting your housing contract, you are affirming that you have reviewed the pamphlet Protect Your Family from Lead In Your Home.",
              ""
            );
          var bedroomText = bedroomText.replace(
          ...
          var bedroomText = bedroomText.replace(
            "Before renting pre-1978 housing, landlords must disclose the presence of known lead-based paint and lead-based paint hazards in the dwelling.",
            ""
          );
          var bedroomText = bedroomText.replace(
          ...
          if (moreBedroomText.match(three)) {
            numBeds = 3;
          }
          if (moreBedroomText.match(four)) {
            numBeds = 4;
          }
          if (moreBedroomText.match(five)) {
            numBeds = 5;
          }
          if (moreBedroomText.match(six)) {
            numBeds = 6;
          }

          if (bedroomText.match(three)) {
            numBeds = 3;
          }
          if (bedroomText.match(four)) {
            numBeds = 4;
          }
          if (bedroomText.match(five)) {
            numBeds = 5;
          }
          if (bedroomText.match(six)) {
            numBeds = 6;
          }
          ...
          var houseName = houseUrl.replace(
            "https://www.wesleyan.edu/reslife/housing/woodframe/",
            ""
          );
          ...
          var houseName = houseName.replace(/(^\w{1})|(\s+\w{1})/g, (letter) =>
            letter.toUpperCase()
          );
          ...
          var quietBool = "loud";
          var houseRegex = new RegExp(
            "Home|Brainerd|Lawn|Huber|Knowles|Williams"
          );
          if (streetName.match(houseRegex)) {
            quietBool = "quiet";
          }

          var amenityText = amenities
            .text()
            .replace(
              "Common Area: couch, chair, end table and coffee tableKitchen: kitchen table, chairs, refrigerator, stove and oven",
              ""
            );
          var amenityText = amenityText.replace(
            "Bedrooms: desk, chair, dresser and bookcase",
            ""
          );
          var amenityText = amenityText.replace(
            "Common Area: couch, chair, end table and coffee tableKitchen: kitchen table, four chairs, refrigerator, stove and ovenBedrooms: desk, chair, dresser, bookcase and full size beds",
            ""
          );
          var amenityText = amenityText.replace(
            "Common Area: couch, chair, end table and coffee tableKitchen: kitchen table, chairs, refrigerator, stove and oven",
          ...
          var amenityText = amenityText.replace(
            "Please note that the 2nd floor has a low ceiling (ceiling height is 6 feet, 2 inches).",
            ""
          );
          var amenityText = amenityText.replace(
            "Common Area: couch, chair, end table and coffee tableKitchen: kitchen table, four chairs, refrigerator, stove and ovenBedrooms: desk, chair, dresser, bookcase and twin size beds",
            ""
          );
          var amenityText = amenityText.replace(
          ...
          var amenityText = amenityText.replace(
            "Kitchen: kitchen table, four chairs, refrigerator, stove and oven",
            ""
          );
          var amenityText = amenityText.replace(
            "Bedrooms: desk, chair, dresser, full bed and bookcase",
            ""
          );
          var amenityText = amenityText.replace(
            "Bedrooms: desk, chair, dresser, bookcase and twin size beds",
            ""
          );
          var amenityText = amenityText.replace(
            "Common Area(A, B, and C): couch, arm chair, end table and coffee tableCommon Area (B): Arm chair",
            ""
          );
          var amenityText = amenityText.replace(
            "Bedrooms: desk, chair, dresser and bookcase",
          ...
          if (amenities.text().match(withD)) {
            ...
            dbh
              ...
              .set(
                {
                  ammenities: { bathrooms: bathroomNum },
                  name: houseNameD,
                  multipleUnits: multiUnit,
                  location: { street: streetName, quiet: quietBool },
                },
                { merge: true }
              )
              .then(() => {
